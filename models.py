...
class AccessControlEquipmentTable(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'access control equipment table'
...
class DepatmentInformationTable(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'depatment information table'
...
class EmployeeInformationTable(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'employee  information table'
...
class OpenRecordThroughAccessControlTable(models.Model):
    ...
    oper_data = models.DateField(db_column='OPER_DATA')  # Field name made lowercase.
    oper_time = models.TimeField(db_column='OPER_TIME')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'open record through access control table'
        unique_together = (('mark_no', 'oper_data', 'oper_time'),)
